...
export const trieInsertSearchLesson = {
  ...
  code: {
    ...
    lines: [
      { number: 30, text: "export function createTrie(words) {", steps: ["initialize"] },
      { number: 31, text: "  const root = createTrieNode(\"node-0\", \"root\", \"\");", steps: ["initialize"] },
      { number: 32, text: "  for (const rawWord of words) {", steps: ["insert-word"] },
      ...
      { number: 37, text: "      }", steps: ["follow-or-create"] },
      { number: 38, text: "      node = node.children.get(character);", steps: ["follow-or-create"] },
      { number: 39, text: "    }", steps: ["insert-word"] },
      { number: 40, text: "    node.terminal = true;", steps: ["mark-terminal"] },
      { number: 41, text: "  }", steps: ["insert-word"] },
      { number: 42, text: "  return root;", steps: ["initialize"] },
      { number: 46, text: "export function searchTrie(words, query) {", steps: ["search-query"] },
